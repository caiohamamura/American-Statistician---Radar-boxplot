...
\newcommand{\blind}{0}
\newcommand{\thetitle}{The radar-boxplot: a boxplot variation for multivariate data}
...
\bigskip
The radar-boxplot provides an intuitive way for visualizing classified multivariate
\section{BibTeX}
